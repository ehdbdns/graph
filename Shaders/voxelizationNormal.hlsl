...
void PS(vertexout pin)
{
    ...
    float4 n = (float4(pin.normal, 0) + 1)/2.0f;
    ...
    switch (level)
    {
        ...
        case 0:{
                ...
                g_clipmap[indexAndLevel.xyz] = float4(n);
            }
            break;
        case 1:{
                ...
                g_clipmap2[indexAndLevel.xyz] = float4(n);
            }
            break;
        case 2:{
                ...
                g_clipmap3[indexAndLevel.xyz] = float4(n);
            }
            break;
        case 3:{
                ...
                g_clipmap4[indexAndLevel.xyz] = float4(n);
            }
            break;
        case 4:{
                ...
                g_clipmap5[indexAndLevel.xyz] = float4(n);
            }
            break;
        case 5:{
                ...
                g_clipmap6[indexAndLevel.xyz] = float4(n);
            }
